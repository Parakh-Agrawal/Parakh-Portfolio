  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
        ...
        >
            ...
            <p className='text-white text-[18px] font-bold cursor-pointer flex'>PARAKH AGRAWAL &nbsp; 
            <span className='sm:block hidden'>|&nbsp; VNIT, NAGPUR</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
                ...
                <div className={`${!toggle ? 'hidden' : 'flex'} p-6 black-gradient absolute top-20 right-20 mx-4 my-2 min-w[140px] z-10 rounded-xl`}>
